...
(function (Promise) {
  ...
  PC98DosBoxLoader.__proto__ = DosBoxLoader;
   ...
   function PCELoader() {
     console.log("hao PCELoader init----->");
     var config = Array.prototype.reduce.call(arguments, extend);
   ...
   */
   ...
   function EmscriptenRunner(canvas, game_data) {
     ...
     Module = { arguments: game_data.emulator_arguments,
                ...
                preInit: function () {
                           // Re-initialize BFS to just use the writable in-memory storage. //haohao
   ...
   */
   ...
   function Emulator(canvas, callbacks, loadFiles) {
     ...
     var start = function (options) {
       ...
       var k, c, game_data;
       this.gameData=game_data;//haohao
       ...
       loading.then(function (_game_data) {
                      console.log("haohao: Emulator  loading.....");
                      return new Promise(function(resolve, reject) {
                        ...
                        if (BrowserFS.FileSystem.IndexedDB.isAvailable()) {
                          console.log("haohao:indexedDb is available");
                          ...
                          deltaFS = new AsyncMirrorFS(inMemoryFS,
                                                      new IndexedDB(function(e, fs) {
                                                                      if (e) {
                                                                        ...
                                                                        console.log("hao:fs sync storage");
                          ...
                          game_data.fs.initialize(function (e) {
                            if (e) {
                              ...
                              function saveat(filename) {
                                console.log("haohao: saveat:"+filename);
                                return function (data) {
                                  if (data !== null) {
